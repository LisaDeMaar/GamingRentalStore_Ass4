...
public class GameCategoryTest {
    ...
    {
        GameCategory category1 = new GameCategory.Builder("CAT001").categoryName("Latest").build();
        
        Assert.assertNotNull(category1);
        
        Assert.assertEquals(category1.getCategoryID(), "CAT001");
    }
}
